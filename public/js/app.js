...
var cancelButton = document.getElementById('cancel-button');
var editButton = document.getElementById('edit-button');
var spanInputTags = Array.from(document.getElementsByClassName('participant-name-input'));
var matchResult = Array.from(document.getElementsByClassName('match-result'));
var matchResultInput = Array.from(document.getElementsByClassName('match-result-input'));
window.buttonPressedTournament = function () {
  console.log("button pressed");
  submitButton.classList.toggle('hidden-element');
  cancelButton.classList.toggle('hidden-element');
  editButton.classList.toggle('hidden-element');
  spanInputTags.forEach(function (item) {
    item.classList.toggle('hidden-element');
  });
  matchResult.forEach(function (item) {
    item.classList.toggle('hidden-element');
  });
  matchResultInput.forEach(function (item) {
    item.classList.toggle('hidden-element');
  });
  return false;
};
